...
const receiveHost = "0.0.0.0"; // Dirección IP para recibir el paquete
const receivePort = 9700; // Puerto para recibir el paquete
startServer(receiveHost, receivePort);
